...
# ape_data = load_raw_data("data/Math_23K.json") + raw_data_new("data/ape_simple_train.json", id_list, overlap_list) + raw_data_new("data/ape_simple_test.json", test_id_list, test_overlap_list)
