...
if dataset_name == "Math23K":
    ...
    if full_mode:
        ...
        var_nums = []
    ckpt_dir = "Math23K_Subtree_SA1_Fold5"
    data_path = "../dataset/math23k/Math_23K.json"
elif dataset_name == "hmwp":
    hidden_size = 384
    batch_size = 8
    ckpt_dir = "hmwp_Subtree_SA_Fold5"
    var_nums = ['x','y']
    ...
    for epoch in range(n_epochs):
        ...
        for idx in range(len(input_lengths)):
            loss = train_tree_with_subtree_semantic_alignment(
                ...
                num_stack_batches[idx], num_size_batches[idx], bert_input_batches[idx],generate_num_ids, encoder, predict, generate, merge, sementic_alignment,
