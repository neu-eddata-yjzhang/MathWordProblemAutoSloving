...
def train_tree_with_subtree_semantic_alignment(input_batch, input_length, target_batch, target_length, nums_stack_batch, num_size_batch,bert_input ,generate_nums,
