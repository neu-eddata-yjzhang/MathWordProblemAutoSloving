...
train_data = json.load(open('/home/work/zhangyijia02/LT/logs/useless/MATHQA/data/MathQA_bert_token_train.json', 'r', encoding='utf-8'))
val_data1 = json.load(open('/home/work/zhangyijia02/LT/logs/useless/MATHQA/data/MathQA_bert_token_test.json', 'r', encoding='utf-8'))
test_data1 = json.load(open('/home/work/zhangyijia02/LT/logs/useless/MATHQA/data/MathQA_bert_token_val.json', 'r', encoding='utf-8'))
...
for fold in range(1):
    ...
    for epoch in range(n_epochs):
        ...
        num_stack_batches, num_pos_batches, num_size_batches,bert_input_batches = prepare_train_batch(train_pairs, batch_size)
        # print("fold:", fold + 1)
        # print("epoch:", epoch + 1)
